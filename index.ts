...
const orderitem = require("./app/orderItem")(prisma);
...
const approvalType = require("./app/approvalType")(prisma);
const workflowApprovalLevel = require("./app/workflowApprovalLevel")(prisma);
const financierConfig = require("./app/financierConfig")(prisma);
const financingAgreement = require("./app/financingAgreement")(prisma);
const financierDisbursement = require("./app/financierDisbursement")(prisma);
const adminFinancierSettlement = require("./app/adminFinancierSettlement")(prisma);
const adminSupplierSettlement = require("./app/adminSupplierSettlement")(prisma);
const supplierSettlement = require("./app/supplierSettlement")(prisma);
...
app.use(config.baseApiPath, orderitem);
...
app.use(config.baseApiPath, approvalType);
app.use(config.baseApiPath, workflowApprovalLevel);
app.use(config.baseApiPath, financierConfig);
app.use(config.baseApiPath, financingAgreement);
app.use(config.baseApiPath, financierDisbursement);
app.use(config.baseApiPath, adminFinancierSettlement);
app.use(config.baseApiPath, adminSupplierSettlement);
app.use(config.baseApiPath, supplierSettlement);
